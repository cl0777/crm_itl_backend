...
let UsersController = class UsersController {
    ...
    async getDepartmentUsers(req) {
        const userId = req.user?.userId;
        if (!userId) {
            throw new common_1.UnauthorizedException('User is not assigned to a department');
        }
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOkResponse)({ description: 'List users' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Get users from my department' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOkResponse)({ description: 'Create user' }),
    (0, roles_decorator_1.Roles)('admin'),
...
__decorate([
    (0, common_1.Patch)('me'),
    (0, swagger_1.ApiOkResponse)({ description: 'Update current user' }),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOkResponse)({ description: 'Update user' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Delete user' }),
    (0, roles_decorator_1.Roles)('admin'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
