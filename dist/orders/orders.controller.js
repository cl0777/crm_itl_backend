...
let OrdersController = class OrdersController {
    ...
    async listMine(req) {
        if (req.user?.role !== 'customer') {
            throw new common_1.ForbiddenException('Only customers can list their orders');
        }
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOkResponse)({ description: 'Create a new order (customer only)' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOkResponse)({ description: 'List my orders (customer only)' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
