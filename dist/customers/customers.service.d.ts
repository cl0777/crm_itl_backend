...
export declare class CustomersService {
    ...
    constructor(customerModel: typeof CustomerModel, customerAccountModel: typeof CustomerAccountModel, userModel: typeof UserModel, jwtService: JwtService);
    ...
    findOne(id: number, userId?: number, userRole?: string, userDepartmentId?: number): Promise<import("./customer.model").CustomerAttributes>;
    update(id: number, dto: UpdateCustomerDto, userId?: number, userRole?: string, userDepartmentId?: number): Promise<import("./customer.model").CustomerAttributes>;
    remove(id: number, userId?: number, userRole?: string, userDepartmentId?: number): Promise<void>;
